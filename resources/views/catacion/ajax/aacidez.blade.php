<div  class="panel panel-border panel-contrast padre_seccion"
      ...
      data_codigo = '00000005'>
  <div class="panel-heading panel-heading-contrast"><b>Acidez</b>
  <div class="tools">
    <span class="badge puntaje">{{$funcion->catacion->value_catacion('00000005',$muestra->id)}}</span>
  </div>
  </div>
