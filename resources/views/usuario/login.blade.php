...
<html lang="{{ app()->getLocale() }}">
  <head>
    ...
    <link rel="icon" href="{{ asset('public/img/icono/acupping.ico') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('public/css/acupping.css?v='.$version) }} "/>


    <title>{{$nombre_sistema}} - Inicio Sessión</title>
        ...
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="panel panel-default panel-border-color panel-border-color-primary">
              ...
              <img src="{{ asset('public/img/acupping.png') }}" alt="logo" width="150" height="150" class="logo-img">
              ...
              <div class="panel-body">
                ...
                <form method="POST" action="{{ url('login') }}">
                  ...
                  <input type='hidden' id='carpeta' class ="none" value="{{$capeta}}"/>
                  <input type="hidden" id="token"  class ="none" name="_token"  value="{{ csrf_token() }}">
