...
! function(t, n) {
    ...
    function p(t, n, e, r, i, o) {
        for (var a, u = 0, s = n.length, l = o.length; u < l; ++u)(a = n[u]) ? (a.__data__ = o[u], r[u] = a) : e[u] = new f(t, o[u]);
    ...
    function d(t, n, e, r, i, o, a) {
        ...
        for (u = 0; u < p; ++u)(s = c[l = "$" + a.call(t, o[u], u, o)]) ? (r[u] = s, s.__data__ = o[u], c[l] = null) : e[u] = new f(t, o[u]);
        ...
        return function(i, o, a) {
            ...
            if (s)
                for (var c = 0, h = s.length; c < h; ++c)
                    if ((u = s[c]).type === t.type && u.name === t.name) return this.removeEventListener(u.type, u.listener, u.capture), this.addEventListener(u.type, u.listener = l, u.capture = e), void(u.value = n);
    ...
    ut.prototype = st.prototype = {
        ...
        select: function(t) {
            ...
            for (var n = this._groups, e = n.length, r = new Array(e), i = 0; i < e; ++i)
                for (var o, a, s = n[i], l = s.length, c = r[i] = new Array(l), h = 0; h < l; ++h)(o = s[h]) && (a = t.call(o, o.__data__, h, s)) && ("__data__" in o && (a.__data__ = o.__data__), c[h] = a);
            return new ut(r, this._parents)
        },
        selectAll: function(t) {
            "function" != typeof t && (t = l(t));
            for (var n = this._groups, e = n.length, r = [], i = [], o = 0; o < e; ++o)
                for (var a, u = n[o], s = u.length, c = 0; c < s; ++c)(a = u[c]) && (r.push(t.call(a, a.__data__, c, u)), i.push(a));
            return new ut(r, i)
        },
        filter: function(t) {
        ...
        data: function(t, n) {
            ...
            for (var a = o.length, u = new Array(a), s = new Array(a), l = new Array(a), c = 0; c < a; ++c) {
                var h = i[c],
                    f = o[c],
                    v = f.length,
        ...
        merge: function(t) {
            for (var n = this._groups, e = t._groups, r = n.length, i = e.length, o = Math.min(r, i), a = new Array(r), u = 0; u < o; ++u)
                for (var s, l = n[u], c = e[u], h = l.length, f = a[u] = new Array(h), p = 0; p < h; ++p)(s = l[p] || c[p]) && (f[p] = s);
            for (; u < r; ++u) a[u] = n[u];
        ...
        attr: function(t, n) {
            ...
            return this.each((null == n ? r.local ? g : y : "function" == typeof n ? r.local ? x : w : r.local ? _ : m)(r, n))
        },
        style: function(t, n, e) {
            return arguments.length > 1 ? this.each((null == n ? M : "function" == typeof n ? N : A)(t, n, null == e ? "" : e)) : k(this.node(), t)
        },
        property: function(t, n) {
            return arguments.length > 1 ? this.each((null == n ? S : "function" == typeof n ? T : E)(t, n)) : this.node()[t]
        },
        ...
        text: function(t) {
            return arguments.length ? this.each(null == t ? I : ("function" == typeof t ? B : D)(t)) : this.node().textContent
        },
        html: function(t) {
            return arguments.length ? this.each(null == t ? X : ("function" == typeof t ? V : H)(t)) : this.node().innerHTML
        },
        raise: function() {
            return this.each($)
        },
    ...
    var ht, ft, pt = (1 === (ht = ct).length && (ft = ht, ht = function(t, n) {
            return ct(ft(t), n)
        }), {
    ...
    function gt(t, n, e) {
        var r = (n - t) / Math.max(0, e),
            ...
            o = r / Math.pow(10, i);
        return i >= 0 ? (o >= dt ? 10 : o >= vt ? 5 : o >= yt ? 2 : 1) * Math.pow(10, i) : -Math.pow(10, -i) / (o >= dt ? 10 : o >= vt ? 5 : o >= yt ? 2 : 1)
    }
    ...
    function jt(t) {
        var n, e;
        return t = (t + "").trim().toLowerCase(), (n = Nt.exec(t)) ? (e = n[1].length, n = parseInt(n[1], 16), 6 === e ? zt(n) : 3 === e ? new Bt(n >> 8 & 15 | n >> 4 & 240, n >> 4 & 15 | 240 & n, (15 & n) << 4 | 15 & n, 1) : 8 === e ? Lt(n >> 24 & 255, n >> 16 & 255, n >> 8 & 255, (255 & n) / 255) : 4 === e ? Lt(n >> 12 & 15 | n >> 8 & 240, n >> 8 & 15 | n >> 4 & 240, n >> 4 & 15 | 240 & n, ((15 & n) << 4 | 15 & n) / 255) : null) : (n = kt.exec(t)) ? new Bt(n[1], n[2], n[3], 1) : (n = St.exec(t)) ? new Bt(255 * n[1] / 100, 255 * n[2] / 100, 255 * n[3] / 100, 1) : (n = Et.exec(t)) ? Lt(n[1], n[2], n[3], n[4]) : (n = Tt.exec(t)) ? Lt(255 * n[1] / 100, 255 * n[2] / 100, 255 * n[3] / 100, n[4]) : (n = Ct.exec(t)) ? $t(n[1], n[2] / 100, n[3] / 100, 1) : (n = Pt.exec(t)) ? $t(n[1], n[2] / 100, n[3] / 100, n[4]) : Rt.hasOwnProperty(t) ? zt(Rt[t]) : "transparent" === t ? new Bt(NaN, NaN, NaN, 0) : null
    }
    ...
    function It(t) {
        return t instanceof xt || (t = jt(t)), t ? new Bt((t = t.rgb()).r, t.g, t.b, t.opacity) : new Bt
    }
    ...
    function $t(t, n, e, r) {
        return r <= 0 ? t = n = e = NaN : e <= 0 || e >= 1 ? t = n = NaN : n <= 0 && (t = NaN), new Yt(t, n, e, r)
    }
    ...
    function Ut(t) {
        ...
        var n = (t = t.rgb()).r / 255,
            ...
            u = o - i,
            s = (o + i) / 2;
        return u ? (a = n === o ? (e - r) / u + 6 * (e < r) : e === o ? (r - n) / u + 2 : (n - e) / u + 4, u /= s < .5 ? o + i : 2 - o - i, a *= 60) : u = s > 0 && s < 1 ? 0 : a, new Yt(a, u, s, t.opacity)
    }
    ...
    _t(xt, jt, {
        ...
        formatRgb: Ht,
        toString: Ht
    })), _t(Yt, (function(t, n, e, r) {
        return 1 === arguments.length ? Ut(t) : new Yt(t, n, e, null == r ? 1 : r)
    }), wt(xt, {
        brighter: function(t) {
            return t = null == t ? 1 / .7 : Math.pow(1 / .7, t), new Yt(this.h, this.s, this.l * t, this.opacity)
        },
        darker: function(t) {
            return t = null == t ? .7 : Math.pow(.7, t), new Yt(this.h, this.s, this.l * t, this.opacity)
        },
        rgb: function() {
            var t = this.h % 360 + 360 * (this.h < 0),
                ...
                r = e + (e < .5 ? e : 1 - e) * n,
                i = 2 * e - r;
            return new Bt(Ft(t >= 240 ? t - 240 : t + 120, i, r), Ft(t, i, r), Ft(t < 120 ? t + 240 : t - 120, i, r), this.opacity)
        },
        displayable: function() {
    ...
    function en(t, n) {
        var e, r = {},
            i = {};
        for (e in null !== t && "object" == typeof t || (t = {}), null !== n && "object" == typeof n || (n = {}), n) e in t ? r[e] = un(t[e], n[e]) : i[e] = n[e];
        return function(t) {
    ...
    function an(t, n) {
        var e, r, i, o = rn.lastIndex = on.lastIndex = 0,
            a = -1,
            u = [],
            s = [];
        for (t += "", n += "";
            (e = rn.exec(t)) && (r = on.exec(n));)(i = r.index) > o && (i = n.slice(o, i), u[a] ? u[a] += i : u[++a] = i), (e = e[0]) === (r = r[0]) ? u[a] ? u[a] += r : u[++a] = r : (u[++a] = null, s.push({
            i: a,
            x: nn(e, r)
        })), o = on.lastIndex;
    ...
    function un(t, n) {
        var e, r, i = typeof n;
        return null == n || "boolean" === i ? Gt(n) : ("number" === i ? nn : "string" === i ? (e = jt(n)) ? (n = e, Wt) : an : n instanceof jt ? Wt : n instanceof Date ? tn : (r = n, !ArrayBuffer.isView(r) || r instanceof DataView ? Array.isArray(n) ? Kt : "function" != typeof n.valueOf && "function" != typeof n.toString || isNaN(n) ? en : nn : Jt))(t, n)
    }
    ...
    var ln, cn, hn, fn, pn = 180 / Math.PI,
        dn = {
            translateX: 0,
            translateY: 0,
            rotate: 0,
    ...
    var gn = yn((function(t) {
            return "none" === t ? dn : (ln || (ln = document.createElement("DIV"), cn = document.documentElement, hn = document.defaultView), ln.style.transform = t, t = hn.getComputedStyle(cn.appendChild(ln), null).getPropertyValue("transform"), cn.removeChild(ln), vn(+(t = t.slice(7, -1).split(","))[0], +t[1], +t[2], +t[3], +t[4], +t[5]))
        }), "px, ", "px)", "deg)"),
        mn = yn((function(t) {
            return null == t ? dn : (fn || (fn = document.createElementNS("http://www.w3.org/2000/svg", "g")), fn.setAttribute("transform", t), (t = fn.transform.baseVal.consolidate()) ? vn((t = t.matrix).a, t.b, t.c, t.d, t.e, t.f) : dn)
        }), ", ", ")", ")");
    ...
    function Mn(t, n, e) {
        var r = t[0],
            ...
            o = n[0],
            a = n[1];
        return i < r ? (r = bn(i, r), o = e(a, o)) : (r = bn(r, i), o = e(o, a)),
            function(t) {
                return o(r(t))
            }
    }
    ...
    function An(t, n, e) {
        var r = Math.min(t.length, n.length) - 1,
            ...
            o = new Array(r),
            a = -1;
        for (t[r] < t[0] && (t = t.slice().reverse(), n = n.slice().reverse()); ++a < r;) i[a] = bn(t[a], t[a + 1]), o[a] = e(n[a], n[a + 1]);
        return function(n) {
            var e = pt(t, n, 1, r) - 1;
            return o[e](i[e](n))
        }
    ...
    function kn() {
        var t, n, e, r, i, o, a = wn,
            u = wn,
            s = un,
            l = xn;

        function c() {
            var t, n, e, s = Math.min(a.length, u.length);
            return l !== xn && (t = a[0], n = a[s - 1], t > n && (e = t, t = n, n = e), l = function(e) {
                return Math.max(t, Math.min(n, e))
            }), r = s > 2 ? An : Mn, i = o = null, h
        }
    ...
    Rn.prototype = On.prototype, On.prototype.toString = function() {
    ...
    var Ln, In, Dn, Bn = Array.prototype.map,
        Xn = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];

    function Hn(t) {
        var n, e, r = void 0 === t.grouping || void 0 === t.thousands ? zn : (n = Bn.call(t.grouping, Number), e = t.thousands + "", function(t, r) {
                for (var i = t.length, o = [], a = 0, u = n[0], s = 0; i > 0 && u > 0 && (s + u + 1 > r && (u = Math.max(1, r - s)), o.push(t.substring(i -= u, i + u)), !((s += u + 1) > r));) u = n[a = (a + 1) % n.length];
                return o.reverse().join(e)
            }),
            i = void 0 === t.currency ? "" : t.currency[0] + "",
            o = void 0 === t.currency ? "" : t.currency[1] + "",
            a = void 0 === t.decimal ? "." : t.decimal + "",
            u = void 0 === t.numerals ? zn : function(t) {
                return function(n) {
        ...
        function h(t) {
            var n = (t = Rn(t)).fill,
                ...
                g = t.trim,
                m = t.type;
            "n" === m ? (v = !0, m = "g") : jn[m] || (void 0 === y && (y = 12), g = !0, m = "g"), (p || "0" === n && "=" === e) && (p = !0, n = "0", e = "=");
            ...
            function M(t) {
                ...
                if ("c" === m) M = x(t) + M, t = "";
                    ...
                    if (t = isNaN(t) ? c : x(Math.abs(t), y), g && (t = function(t) {
                        ...
                        }(t)), A && 0 == +t && "+" !== h && (A = !1), f = (A ? "(" === h ? h : l : "-" === h || "(" === h ? "" : h) + f, M = ("s" === m ? Xn[8 + Cn / 3] : "") + M + (A && "(" === h ? ")" : ""), b)
        ...
        switch ((r = Rn(null == r ? ",f" : r)).type) {
            case "s":
                ...
                return null != r.precision || isNaN(i = function(t, n) {
                    return Math.max(0, 3 * Math.max(-8, Math.min(8, Math.floor(Tn(n) / 3))) - Tn(Math.abs(t)))
                }(o, a)) || (r.precision = i), Dn(r, a);
            case "":
            case "e":
            case "g":
            case "p":
    ...
    function $n(t) {
        ...
        return t.ticks = function(t) {
            ...
            return function(t, n, e) {
                ...
                if ((r = n < t) && (i = t, t = n, n = i), 0 === (a = gt(t, n, e)) || !isFinite(a)) return [];
                if (a > 0)
            ...
            var r, i = n(),
                ...
                u = i[o],
                s = i[a];
            return s < u && (r = u, u = s, s = r, r = o, o = a, a = r), (r = gt(u, s, e)) > 0 ? r = gt(u = Math.floor(u / r) * r, s = Math.ceil(s / r) * r, e) : r < 0 && (r = gt(u = Math.ceil(u * r) / r, s = Math.floor(s * r) / r, e)), r > 0 ? (i[o] = Math.floor(u / r) * r, i[a] = Math.ceil(s / r) * r, n(i)) : r < 0 && (i[o] = Math.ceil(u * r) / r, i[a] = Math.floor(s * r) / r, n(i)), t
        }, t
    }
    ...
    function Zn(t) {
        ...
        function r() {
            return 1 === e ? t(xn, xn) : .5 === e ? t(Fn, Gn) : t(Yn(e), Yn(1 / e))
        }
    ...
    function Wn(t, n) {
        var e, r, i, o, a, u = new ne(t),
            s = +t.value && (u.value = t.value),
            l = [u];
        for (null == n && (n = Jn); e = l.pop();)
            if (s && (e.value = +e.data.value), (i = n(e.data)) && (a = i.length))
                for (e.children = new Array(a), o = a - 1; o >= 0; --o) l.push(r = e.children[o] = new ne(i[o])), r.parent = e, r.depth = e.depth + 1;
            ...
            return i.x0 = i.y0 = e, i.x1 = t, i.y1 = n / o, i.eachBefore(function(t, n) {
                return function(r) {
                    r.children && function(t, n, e, r, i) {
                        for (var o, a = t.children, u = -1, s = a.length, l = t.value && (r - n) / t.value; ++u < s;)(o = a[u]).y0 = e, o.y1 = i, o.x0 = n, o.x1 = n += o.value * l
    ...
    Ln = Hn({
        ...
        currency: ["$", ""],
        minus: "-"
    }), In = Ln.format, Dn = Ln.formatPrefix, ne.prototype = Wn.prototype = {
        constructor: ne,
        count: function() {
    ...
    ue.prototype = se.prototype = {
            ...
            if (null === this._x1) this._ += "M" + (this._x1 = t) + "," + (this._y1 = n);
                ...
                if (Math.abs(c * u - s * l) > 1e-6 && i) {
                    var f = e - o,
                        ...
                        _ = m / g,
                        w = m / y;
                    Math.abs(_ - 1) > 1e-6 && (this._ += "L" + (t + _ * l) + "," + (n + _ * c)), this._ += "A" + i + "," + i + ",0,0," + +(c * f > l * p) + "," + (this._x1 = t + w * u) + "," + (this._y1 = n + w * s)
        ...
        arc: function(t, n, e, r, i, o) {
            ...
            null === this._x1 ? this._ += "M" + s + "," + l : (Math.abs(this._x1 - s) > 1e-6 || Math.abs(this._y1 - l) > 1e-6) && (this._ += "L" + s + "," + l), e && (h < 0 && (h = h % oe + oe), h > ae ? this._ += "A" + e + "," + e + ",0,1," + c + "," + (t - a) + "," + (n - u) + "A" + e + "," + e + ",0,1," + c + "," + (this._x1 = s) + "," + (this._y1 = l) : h > 1e-6 && (this._ += "A" + e + "," + e + ",0," + +(h >= ie) + "," + c + "," + (this._x1 = t + e * Math.cos(i)) + "," + (this._y1 = n + e * Math.sin(i))))
        },
        ...
        on: function(t, n) {
            ...
            if (!(arguments.length < 2)) {
                ...
                for (; ++o < a;)
                    ...
                    for (e in r) r[e] = qe(r[e], t.name, null);
                return this
            }
            for (; ++o < a;)
                if ((e = (t = i[o]).type) && (e = Oe(r[e], t.name))) return e
        },
        copy: function() {
            var t = {},
                n = this._;
    ...
    function We(t) {
        Le || (Ie && (Ie = clearTimeout(Ie)), t - Xe > 24 ? (t < 1 / 0 && (Ie = setTimeout(Ze, t - Ve.now() - He)), De && (De = clearInterval(De))) : (De || (Be = Ve.now(), De = setInterval(Qe, 1e3)), Le = 1, $e(Ze)))
    }
    ...
    Fe.prototype = Ge.prototype = {
        ...
        restart: function(t, n, e) {
            ...
            e = (null == e ? Ue() : +e) + (null == n ? 0 : +n), this._next || ze === this || (ze ? ze._next = this : je = this, ze = this), this._call = t, this._time = e, We()
        },
        stop: function() {
    ...
    function sr(t, n) {
        var e;
        return ("number" == typeof n ? nn : n instanceof jt ? Wt : (e = jt(n)) ? (n = e, Wt) : an)(t, n)
    }
    ...
    Rr.prototype = Or.prototype = {
        ...
        select: function(t) {
            ...
            for (var r = this._groups, i = r.length, o = new Array(i), a = 0; a < i; ++a)
                for (var s, l, c = r[a], h = c.length, f = o[a] = new Array(h), p = 0; p < h; ++p)(s = c[p]) && (l = t.call(s, s.__data__, p, c)) && ("__data__" in s && (l.__data__ = s.__data__), f[p] = l, nr(f[p], n, e, p, f, ir(s, e)));
        ...
        selectAll: function(t) {
            ...
            for (var r = this._groups, i = r.length, o = [], a = [], u = 0; u < i; ++u)
                for (var s, c = r[u], h = c.length, f = 0; f < h; ++f)
                    if (s = c[f]) {
                        for (var p, d = t.call(s, s.__data__, f, c), v = ir(s, e), y = 0, g = d.length; y < g; ++y)(p = d[y]) && nr(p, n, e, y, d, v);
                        o.push(d), a.push(s)
                    }
        ...
        transition: function() {
            for (var t = this._name, n = this._id, e = qr(), r = this._groups, i = r.length, o = 0; o < i; ++o)
        ...
        attr: function(t, n) {
            var r = e(t),
                i = "transform" === r ? mn : sr;
            return this.attrTween(t, "function" == typeof n ? (r.local ? dr : pr)(r, i, ur(this, "attr." + t, n)) : null == n ? (r.local ? cr : lr)(r) : (r.local ? fr : hr)(r, i, n))
        },
            ...
            return null == n ? this.styleTween(t, function(t, n) {
                ...
                return function() {
                    var a = k(this, t),
                        u = e(this),
                        s = u + "";
                    return null == u && (this.style.removeProperty(t), s = u = k(this, t)), a === s ? null : a === r && s === i ? o : (i = s, o = n(r = a, u))
                }
            }(t, r, ur(this, "style." + t, n))).each(function(t, n) {
        ...
        delay: function(t) {
            var n = this._id;
            return arguments.length ? this.each(("function" == typeof t ? _r : wr)(n, t)) : ir(this.node(), n).delay
        },
        duration: function(t) {
            var n = this._id;
            return arguments.length ? this.each(("function" == typeof t ? xr : br)(n, t)) : ir(this.node(), n).duration
        },
        ease: function(t) {
            var n = this._id;
    ...
    st.prototype.interrupt = function(t) {
        ...
        var n, e;
        t instanceof Rr ? (n = t._id, t = t._name) : (n = qr(), (e = zr).time = Ue(), t = null == t ? null : t + "");
        for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
            for (var a, u = r[o], s = u.length, l = 0; l < s; ++l)(a = u[l]) && nr(a, t, n, l, u, e || Lr(a, n));
    ...
    var Hr, Vr, $r, Ur, Yr, Fr, Gr, Zr, Qr, Wr, Jr, Kr, ti, ni, ei = function(t) {
    ...
    return Hr = {
            ...
            init: function(t, n) {
                var e = this;
                n.chartId = Math.round(1e12 * Math.random()), n.radiusScale = function t() {
                    var n = Zn(kn());
                    return n.copy = function() {
                        return Nn(n, t()).exponent(n.exponent())
                    }, mt.apply(n, arguments), n
                }(), n.angleScale = Un().domain([0, 10]).range([0, 2 * Math.PI]).clamp(!0), n.arc = function() {
                    var t = be,
                        n = Me,
                        e = le(0),
                        r = null,
                    ...
                    function s() {
                        var s, l, c = +t.apply(this, arguments),
                        ...
                        if (u || (u = s = se()), h < c && (l = h, h = c, c = l), h > 1e-12)
                            if (d > _e - 1e-12) u.moveTo(h * fe(f), h * ve(f)), u.arc(0, 0, h, f, p, !v), c > 1e-12 && (u.moveTo(c * fe(p), c * ve(p)), u.arc(0, 0, c, p, f, v));
                            else {
                                var y, g, m = f,
                                    _ = p,
                                    w = f,
                                ...
                                if (N > 1e-12) {
                                    var T = xe(N / c * ve(A)),
                                        C = xe(N / h * ve(A));
                                    (b -= 2 * T) > 1e-12 ? (w += T *= v ? 1 : -1, x -= T) : (b = 0, w = x = (f + p) / 2), (M -= 2 * C) > 1e-12 ? (m += C *= v ? 1 : -1, _ -= C) : (M = 0, m = _ = (f + p) / 2)
                                }
                                var P = h * fe(m),
                                    R = h * ve(m),
                                    O = c * fe(x),
                                ...
                                if (k > 1e-12) {
                                    ...
                                    if (d < ge && (j = Se(P, R, I, D, z, L, O, q))) {
                                        var B = P - j[0],
                                            ...
                                            H = z - j[0],
                                            V = L - j[1],
                                            $ = 1 / ve(we((B * H + X * V) / (ye(B * B + X * X) * ye(H * H + V * V))) / 2),
                                            U = ye(j[0] * j[0] + j[1] * j[1]);
                                        S = de(k, (c - U) / ($ - 1)), E = de(k, (h - U) / ($ + 1))
                                    }
                                }
                                M > 1e-12 ? E > 1e-12 ? (y = Ee(I, D, P, R, h, E, v), g = Ee(z, L, O, q, h, E, v), u.moveTo(y.cx + y.x01, y.cy + y.y01), E < k ? u.arc(y.cx, y.cy, E, he(y.y01, y.x01), he(g.y01, g.x01), !v) : (u.arc(y.cx, y.cy, E, he(y.y01, y.x01), he(y.y11, y.x11), !v), u.arc(0, 0, h, he(y.cy + y.y11, y.cx + y.x11), he(g.cy + g.y11, g.cx + g.x11), !v), u.arc(g.cx, g.cy, E, he(g.y11, g.x11), he(g.y01, g.x01), !v))) : (u.moveTo(P, R), u.arc(0, 0, h, m, _, !v)) : u.moveTo(P, R), c > 1e-12 && b > 1e-12 ? S > 1e-12 ? (y = Ee(O, q, z, L, c, -S, v), g = Ee(P, R, I, D, c, -S, v), u.lineTo(y.cx + y.x01, y.cy + y.y01), S < k ? u.arc(y.cx, y.cy, S, he(y.y01, y.x01), he(g.y01, g.x01), !v) : (u.arc(y.cx, y.cy, S, he(y.y01, y.x01), he(y.y11, y.x11), !v), u.arc(0, 0, c, he(y.cy + y.y11, y.cx + y.x11), he(g.cy + g.y11, g.cx + g.x11), v), u.arc(g.cx, g.cy, S, he(g.y11, g.x11), he(g.y01, g.x01), !v))) : u.arc(0, 0, c, x, w, v) : u.lineTo(O, q)
                            }
                        else u.moveTo(0, 0);
                    ...
                    return s.centroid = function() {
                        ...
                        return arguments.length ? (r = null == t ? null : "function" == typeof t ? t : le(+t), s) : r
                ...
                n.svg = r.append("svg"), n.canvas = n.svg.append("g"), n.tooltip = r.append("div").attr("class", "sunburst-tooltip"), r.on("mousemove", (function() {
                    var t = function(t) {
                        var n = lt();
                    ...
                    n.tooltip.style("left", t[0] + "px").style("top", t[1] + "px").style("transform", "translate(-".concat(t[0] / n.width * 100, "%, 21px)"))
            ...
            update: function(t) {
                ...
                if (t.radiusScale.range([e * Math.max(0, Math.min(1, t.centerRadius)), e]), t.radiusScaleExponent > 0 && t.radiusScale.exponent(t.radiusScaleExponent), t.svg.style("width", t.width + "px").style("height", t.height + "px").attr("viewBox", "".concat(-t.width / 2, " ").concat(-t.height / 2, " ").concat(t.width, " ").concat(t.height)), t.layoutData) {
                    var r = t.focusOnNode && t.focusOnNode.__dataNode.y0 >= 0 && t.focusOnNode.__dataNode || {
                        ...
                        l = Math.min(1, r.y0 + s * Math.min(r.hasOwnProperty("height") ? r.height + 1 : 1 / 0, t.maxLevels || 1 / 0));
                    ...
                    var h = i.enter().append("g").attr("class", "slice").style("opacity", 0).on("click", (function(e) {
                        W.stopPropagation(), (t.onClick || n.focusOnNode)(e.data)
                    })).on("mouseover", (function(n) {
                        W.stopPropagation(), t.onHover && t.onHover(n.data), t.tooltip.style("display", t.showTooltip(n.data, n) ? "inline" : "none"), t.tooltip.html(''.concat(t.tooltipTitle ? t.tooltipTitle(n.data, n) : function(t) {
                            for (var n = [], e = t; e;) n.unshift(e), e = e.parent;
                            return n
                        }(n).slice(t.excludeRoot ? 1 : 0).map((function(t) {
                            return o(t.data)
                        })).join(" → "), "").concat(t.tooltipContent(n.data, n)))
                    })).on("mouseout", (function() {
                        t.tooltip.style("display", "none")
                    }));
                    h.append("path").attr("class", "main-arc").style("fill", (function(t) {
                        return a(t.data, t.parent)
                    })), h.append("path").attr("class", "hidden-arc").attr("id", (function(n) {
                        return "hidden-arc-".concat(t.chartId, "-").concat(n.id)
                    }));
                    var f = h.append("text").attr("class", "path-label");
                    f.append("textPath").attr("class", "text-contour").attr("startOffset", "50%").attr("xlink:href", (function(n) {
                        return "#hidden-arc-".concat(t.chartId, "-").concat(n.id)
                    })), f.append("textPath").attr("class", "text-stroke").attr("startOffset", "50%").attr("xlink:href", (function(n) {
                        return "#hidden-arc-".concat(t.chartId, "-").concat(n.id)
                    }));
                    var p = i.merge(h);
                    p.style("opacity", 1), p.select("path.main-arc").transition(u).attrTween("d", (function(n) {
                        return function() {
                            return t.arc(n)
                        }
                    })).style("fill", (function(t) {
                        return a(t.data, t.parent)
                    })), p.select("path.hidden-arc").transition(u).attrTween("d", (function(t) {
                        return function() {
                            return d(t)
                        }
                    })), p.select(".path-label").transition(u).styleTween("display", (function(n) {
                        return function() {
                    ...
                    })), p.selectAll("text.path-label").select("textPath.text-contour"), p.selectAll("text.path-label").select("textPath.text-stroke"), p.selectAll("text.path-label").selectAll("textPath").text((function(t) {
                        return o(t.data)
                    }))
                }
        ...
        }, Vr = Hr.stateInit, $r = void 0 === Vr ? function() {
            return {}
        } : Vr, Ur = Hr.props, Yr = void 0 === Ur ? {} : Ur, Fr = Hr.methods, Gr = void 0 === Fr ? {} : Fr, Zr = Hr.aliases, Qr = void 0 === Zr ? {} : Zr, Wr = Hr.init, Jr = void 0 === Wr ? function() {} : Wr, Kr = Hr.update, ti = void 0 === Kr ? function() {} : Kr, ni = Object.keys(Yr).map((function(t) {
            return new Xr(t, Yr[t])
        })),
        function() {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                n = Object.assign({}, $r instanceof Function ? $r(t) : $r, {
                    initialised: !1
                }),
                e = {};
            ...
            return ni.forEach((function(t) {
                r[t.name] = function(t) {
                    ...
                    return function(t) {
                        ...
                        var s = void 0 === t ? h : t;
                        return n[i] = s, l.call(r, s, n, a), !e.hasOwnProperty(i) && (e[i] = a), u && o(), r
                    }
                }(t)
